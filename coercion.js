...
var c = String(a); //Aquí obligamos a la variable a convertirse en string con el metodo String() (coerción explícita)
console.log(c);

var d = Number(c); //Aquí obligamos a la variable a convertirse en número con el metodo Number() (coerción explícita)
console.log(d);